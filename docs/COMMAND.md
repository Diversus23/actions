...
Синонимы: [--out, -o].
- *template*: Шаблон для создания файла с новостью. По умолчанию "Simple.html". Доступные шаблоны: Simple.html, SimpleText.txt, SimpleTextWithoutVersion.txt, SimpleWithoutVersion.html, Softonit.html, Standart.html (не обязательный).
