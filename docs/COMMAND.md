...
Синонимы: [--out, -o].
- *format*: Формат генерации документации. Поддерживается txt, html, htmlfull, htmlall, htmlfullall.
...
htmlall: Документация в формате HTML. Файл конвертируется полностью
htmlfullall: Документация в формате HTML. Готовый HTML-файл со всеми стилями и с полным оформлением. Файл конвертируется полностью
Синонимы: [--format, -f].
