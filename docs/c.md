...
- [actions.os](#actions.os) Приложение для CI/CD
...
Синонимы: [--file, -f].
Значение по умолчанию: "c:\Projects\actions1c\docs\c.md".
...
- *FILENAME*: Имя файла CHANGELOG.md в формате MarkDown, который необходимо инициализировать.
