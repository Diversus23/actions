...
Функция СравнитьВерсии(Знач ЭтаВерсия, Знач БольшеЧемВерсия) Экспорт
	...
	Если ТипЗнч(ЭтаВерсия) <> Тип("Строка") Тогда
		ВызватьИсключение "СравнитьВерсии: Передали неверный параметр <ЭтаВерсия>. Ожидается строка, передано " + ТипЗнч(ЭтаВерсия);
	КонецЕсли;
	Если ТипЗнч(БольшеЧемВерсия) <> Тип("Строка") Тогда
		ВызватьИсключение "СравнитьВерсии: Передали неверный параметр <БольшеЧемВерсия>. Ожидается строка, передано " + ТипЗнч(ЭтаВерсия);;
	КонецЕсли;
