...
Процедура ЗарегистрироватьКоманды(Знач Парсер) Экспорт
	...
	ДобавитьКоманду("changelog-init", "КомандаУправлениеChangeLog", Парсер, "КомандаУправлениеChangeLog");
	ДобавитьКоманду("changelog", "КомандаУправлениеChangeLog", Парсер);
