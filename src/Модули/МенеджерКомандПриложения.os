...
Процедура ЗарегистрироватьКоманды(Знач Парсер) Экспорт
	...
	ДобавитьКоманду("zip-add", "КомандаУправлениеZIP", Парсер);
	ДобавитьКоманду("zip-extract", "КомандаУправлениеZIP", Парсер);
	...
	ДобавитьКоманду("obfuscation", "КомандаОбфускация", Парсер, "Обфускация");
	...
	ДобавитьКоманду("checksum", "КомандаКонтрольнаяСумма", Парсер, "КонтрольнаяСумма");
	ДобавитьКоманду(Перечисления.ДействияСFTP.Получение, "КомандаУправлениеFTP", Парсер);
	ДобавитьКоманду(Перечисления.ДействияСFTP.Отправка, "КомандаУправлениеFTP", Парсер);
...
Процедура ДобавитьКоманду(Знач ИмяКоманды, Знач КлассРеализации, Знач Парсер, 
	Знач ДополнительноеОписание = Неопределено)
...
Функция ТекстовоеОписаниеКоманд() Экспорт
	...
	ВозможныеКоманды.Сортировать("Команда");
	ПС = Символы.ПС;
	ДС = ПС + ПС;
