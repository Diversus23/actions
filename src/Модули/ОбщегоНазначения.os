...
Функция ВыполнитьПроверкуСистемы(Знач ВыполнятьПроверку = Истина) Экспорт
	...
	// ibcmd
	Успешно = ?(ВыполнятьПроверку, РаботаIbcmd.ПроверитьУстановкуIbcmd(), Ложь);
	Текст = "Не будут работать команды ibcmd => Установите платформу 1С с компонентом ibcmd (8.3.20 и выше)";
	Ссылка = "https://releases.1c.ru/project/Platform83";
	ДобавитьПроверку(Таблица, Успешно, "ibcmd", Текст, Ссылка);
