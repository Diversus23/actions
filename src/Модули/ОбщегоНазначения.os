...
//
Процедура ВывестиСтруктуруВКонсоль(Знач Структура) Экспорт

	Сообщить(ТекстВыводаВКонсоль("Структура", Структура));
...
//
Процедура ВывестиМассивВКонсоль(Знач Массив) Экспорт

	Сообщить(ТекстВыводаВКонсоль("Массив", Массив));
