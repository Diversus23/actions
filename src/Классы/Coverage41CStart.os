...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	Массив.Добавить("--infobase " + ФайловыеОперации.ОбернутьПутьВКавычки(Параметры.ИнформационнаяБаза));
	Массив.Добавить("--debugger " + ФайловыеОперации.ОбернутьПутьВКавычки(Параметры.Отладчик));
	Массив.Добавить("--projectDir " + ФайловыеОперации.ОбернутьПутьВКавычки(Параметры.КаталогПроекта));
	Массив.Добавить("--out " + ФайловыеОперации.ОбернутьПутьВКавычки(Параметры.Результат));
