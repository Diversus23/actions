...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	Если ФайловыеОперации.КаталогСуществует(ПараметрыКоманды.Каталог) Тогда
		...
		Лог.Информация("Начало удаления каталога/файлов: <%1> маска: %2", ПараметрыКоманды.Каталог,
		...
		Попытка
			...
			КонецЕсли;
			Лог.Информация("Каталог/файлы удалены: <%1> маска: %2", ПараметрыКоманды.Каталог, ПараметрыКоманды.Маска);
		Исключение
