...
Функция Добавить(Знач МассивФайлов) Экспорт
	...
	Ожидаем.Что(МассивФайлов.Количество(), "Архиватор.Добавить: не задан параметр ИмяАрхива").Больше(0);
...
Процедура ПриСозданииОбъекта(ИмяАрхива)
	...
	Ожидаем.Что(ИмяАрхива, "Архиватор: не задан параметр ИмяАрхива").Заполнено();
    ИмяФайла = ИмяАрхива;	
