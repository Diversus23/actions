...
Функция ПолучитьСтруктуруПараметров(Знач Команда)
	...
	ПараметрыКоманды.Вставить("ТипУдаления", ЧтениеОпций.ЗначениеОпции("type", Ложь,
		Перечисления.ТипУстареванияФайлов.День));
	ПараметрыКоманды.Вставить("РекурсивноеУдаление", ЧтениеОпций.ЗначениеОпции("recursive", Ложь));
	ПараметрыКоманды.Вставить("РекурсивноеУдаление", ЗначениеЗаполнено(ПараметрыКоманды.РекурсивноеУдаление));
	ПараметрыКоманды.Вставить("УдалитьКаталогЕслиПуст", ЧтениеОпций.ЗначениеОпции("delifempty", Ложь));
	ПараметрыКоманды.Вставить("УдалитьКаталогЕслиПуст", ЗначениеЗаполнено(ПараметрыКоманды.УдалитьКаталогЕслиПуст));	
...
Процедура УдалитьСтарыеФайлы(Знач Параметры)
	...
	ПродолжительностьЧаса = 60 * ПродолжительностьМинуты;
	ЧасовВСутках = 24;
	...
	Если МассивФайлов.Количество() > 0 Тогда
		...
		ТЗ.Сортировать("ЭтоФайл Убыв, ИмяФайла Убыв");
