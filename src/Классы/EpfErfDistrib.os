...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	ИмяФайла = Строка(Параметры.Префикс) + СтрЗаменить(Параметры.Версия, ".", "_") + "_full.zip";
	...
	ИмяФайлаОбновления = Параметры.Префикс + СтрЗаменить(Параметры.Версия, ".", "_") + "_upd.zip";
