...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Текст = СтрШаблон("%1 %2", 
		"Имя категории тестов.",
		"Если не указан, имя категории будет соответствовать последнему каталогу из пути (не обязательный)");
	Команда.Опция("name n", "",	Текст)
		.ТСтрока();
...
Функция ПолучитьСтруктуруПараметров(Знач Команда)
	...
	ПараметрыКоманды.Вставить("ИмяКатегории", ЧтениеОпций.ЗначениеОпции("name", Ложь));
