...
Функция ПолучитьСтруктуруПараметров(Знач Команда)
	...
	ПараметрыКоманды.Вставить("Действие", ЧтениеОпций.ЗначениеОпции("action", Ложь, 
		Перечисления.ДействияJSON.УстановитьНастройку));
	...
	Если ПараметрыКоманды.Действие = Перечисления.ДействияJSON.УстановитьНастройку
		...
		Если НЕ ЗначениеЗаполнено(Значение) Тогда
			ТекстОшибки = "Не задано значение. Один из параметров на выбор: --string, --number, --boolean, --date";
