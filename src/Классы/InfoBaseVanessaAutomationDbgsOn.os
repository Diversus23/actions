...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("port p", "",
		"Порт сервера отладки. По умолчанию 1550. Если порт будет занят, то будет попытка найти свободный порт (не обязательный)")
		.ТЧисло();	

	Команда.Опция("file f", "",
		"Файл-флаг с результатом запуска dbgs. По умолчанию ""dbgs.json"". Нужен для последующей остановки сервера отладки (не обязательный)")
		.ТСтрока();	
