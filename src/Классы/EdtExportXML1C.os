...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("workspace w", "",
		"Каталог рабочего пространства для запуска 1C:Enterprise Development Tools (обязательный)")
		.ТСтрока();
...
Функция ПолучитьСтруктуруПараметров(Знач Команда)
	...
	КонецЕсли;
	Если НЕ ФайловыеОперации.КаталогСуществует(ПараметрыКоманды.КаталогПространства) Тогда
		ОбщегоНазначения.ЗавершениеРаботыОшибка(ТекстОшибки, "--workspace", ПараметрыКоманды.КаталогПространства);
	КонецЕсли;
