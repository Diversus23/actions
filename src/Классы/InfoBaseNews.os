...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Текст = СтрШаблон(ТекстШаблона, "HTML-письму для рассылки");
	Команда.Опция("letter l", "", Текст)
		.ТСтрока();
...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	МенеджерКонфигуратора.СохранитьИнформациюОбОбновлении(Параметры, ЧтениеОпций);
...
Функция ПолучитьСтруктуруПараметров(Знач Команда)
	...
	ПараметрыКоманды.Вставить("LETTER", ЧтениеОпций.ЗначениеОпции("letter"));
	ПараметрыКоманды.Вставить("HTML", ЧтениеОпций.ЗначениеОпции("html"));
	ПараметрыКоманды.Вставить("TXT", ЧтениеОпций.ЗначениеОпции("txt"));
	Если НЕ ЗначениеЗаполнено(ПараметрыКоманды.HTML) 
		И НЕ ЗначениеЗаполнено(ПараметрыКоманды.TXT) 
		И НЕ ЗначениеЗаполнено(ПараметрыКоманды.LETTER) Тогда
...
Функция СтрокаОшибкиФайлов()
	Возврат "Необходимо заполнение одной из опций ""--html"" или ""--txt"" или ""--letter""";
КонецФункции
