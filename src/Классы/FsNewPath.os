...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("clear empty с e", "",
		"Если опция задана, то создаваемый/созданный каталог будет рекурсивно очищен")
		.ТБулево();		
...
Функция ПолучитьСтруктуруПараметров(Знач Команда)
	...
	ПараметрыКоманды.ОчищатьКаталог = ЗначениеЗаполнено(ПараметрыКоманды.ОчищатьКаталог);
