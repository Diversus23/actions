...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("shared_path sp", "",
		"Каталог общих файлов, которые будут включены в дистриубтив (не обязательный)")
		.ТСтрока();

	Текст = СтрШаблон(Шаблон2,
		"Постащик дистриубтива.",
		"Если не будет задан, информация о постащвике будет получена из информационной базы 1С (не обязательный)");
