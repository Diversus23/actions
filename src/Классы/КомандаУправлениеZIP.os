...
Функция ВыполнитьКоманду(Знач Параметры, Знач ДополнительныеПараметры = Неопределено) Экспорт
	Если мДействие = Перечисления.ДействияСАрхивом.Создание Тогда
		КодВозврата = ВыполнитьКомандуСоздание(Параметры, ДополнительныеПараметры);
	Иначе
		КодВозврата = ВыполнитьКомандуРаспаковка(Параметры, ДополнительныеПараметры);
	КонецЕсли;

	Возврат КодВозврата;
КонецФункции

Функция ВыполнитьКомандуСоздание(Знач Параметры, Знач ДополнительныеПараметры = Неопределено)
...
Функция ВыполнитьКомандуРаспаковка(Знач Параметры, Знач ДополнительныеПараметры = Неопределено)
