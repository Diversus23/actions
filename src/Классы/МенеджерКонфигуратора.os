...
//
Процедура СохранитьИнформациюОбОбновлении(Знач Параметры, ЧтениеОпций) Экспорт	
	...
	Если ЗначениеЗаполнено(Параметры.LETTER) Тогда
		...
		СоздатьОписаниеОбновленияДляРассылки(Параметры.LETTER, Параметры, ЧтениеОпций, ИнформацияОМетаданных.ОписаниеИзмененийJSON);
...
Процедура СоздатьОписаниеОбновленияДляРассылки(ИмяФайла, ПараметрыОбновления, ЧтениеОпций, JSON)
