...
Процедура СоздатьДистрибутив(Знач Параметры) Экспорт
	...
	Лог.Информация("Начало создания дистриубтива");
	...
	// ToDo
	Создать_1cv8_mft(КаталогВерсии, Параметры.Назначение, Параметры.НазначениеДемо);
	...
	СоздатьФайлМанифеста(ИмяФайлаМанифеста, Префикс, КаталогСборки, КаталогОбщихФайлов);
...
Процедура Создать_1cv8_mft(Знач КаталогСборки, Знач Назначение, Знач НазначениеДемо)
	
	Лог.Информация("Начало создания файла 1cv8.mft в %1", КаталогСборки);	
	
	// Генерируем новый файл 1cv8.mft
	Файл = Новый ТекстовыйДокумент;
	Файл.ДобавитьСтроку("Vendor=" + ИнформацияОМетаданных.Поставщик);
	...
	Файл.ДобавитьСтроку("Destination=" + Назначение);
	...
	Файл.ДобавитьСтроку("Destination=" + НазначениеДемо);
...
Процедура СоздатьФайлМанифеста(Знач ИмяФайла, Знач Префикс, Знач КаталогСборки, Знач КаталогОбщихФайлов)
	...
	Файл1cv8upd = ОбъединитьПути(КаталогСборкиВерсия, "Дополнительные файлы", "1cv8upd.htm");
	ФайлReadMe = ОбъединитьПути(КаталогСборкиВерсия, "Дополнительные файлы", "ReadMe.txt");
	ФайлUpdInfo = ОбъединитьПути(КаталогСборкиВерсия, "Дополнительные файлы", "UpdInfo.txt");
	...
	Файл.ДобавитьСтроку("},");
	Файл.ДобавитьСтроку("{1,2,");
	Файл.ДобавитьСтроку("{""en"",""" + ИнформацияОМетаданных.Синоним + """},");
	Файл.ДобавитьСтроку("{""ru"",""" + ИнформацияОМетаданных.Синоним + """}");
	Файл.ДобавитьСтроку("},");
	Файл.ДобавитьСтроку("{#base64:}");
	Файл.ДобавитьСтроку("},");
	Файл.ДобавитьСтроку("{1,");
	Файл.ДобавитьСтроку("{1,0,""" + ИнформацияОМетаданных.Имя + """,""ООО """"Софтонит"""" (Барилко Виталий Викторович)"",""" + Версия + """,""SoftOnIT\" + Префикс + "\" + ВерсияПодчеркивания + """,");
	Файл.ДобавитьСтроку("{");
	Файл.ДобавитьСтроку("{""/"",");
	Файл.ДобавитьСтроку("{7,");
	Файл.ДобавитьСтроку("{c61a3081-db7b-4d57-b836-150d73beff1f,""Файл конфигурации"",1,00000000-0000-0000-0000-000000000000,""" + ИнформацияОМетаданных.Синоним + ""","""",00000000-0000-0000-0000-000000000000,"""",1,1,1,1},");
	Файл.ДобавитьСтроку("{ed7bf966-330d-46f0-9bf0-57a0db7ecd04,""Файл выгрузки информационной базы"",1,00000000-0000-0000-0000-000000000000,""" + ИнформацияОМетаданных.Синоним + " (демо)"","""",00000000-0000-0000-0000-000000000000,"""",0,2,1,1},");
