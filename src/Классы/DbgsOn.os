...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	Пока Истина Цикл
		...
		Если ПараметрыСистемы.ЭтоWindows Тогда
			...
			// (это связано с тем, что в stderr появляется ошибка и она)
			...
			ТекстКоманды = СтрШаблон(
				...
				|$ProcessInfo.Arguments = ""--addr=%2 --port=%3"";
				...
				|}
				|", ИмяФайлаОтладчика, Параметры.Адрес, ПортСтрокой, ИмяВременногоФайла);
