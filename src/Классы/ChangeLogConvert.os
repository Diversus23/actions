...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("minifyhtml", "",
		"Минимизировать HTML-файл. Имеет смысл только для HTML-файлов (необязательный)")
		.ТБулево();
	...
	Команда.Опция("maximgwidth", "",
		...
		+ "Полезна для новостей, которые будут отправлены по почте в формате HTML. "
	...
	Команда.Опция("lazyload", "",
		...
		+ "Полезна для новостей в формате HTML, где много картинок и которые из-за этого будут долго открываться. "
...
Функция ПолучитьСтруктуруПараметров(Знач Команда)
	...
	ПараметрыКоманды.Вставить("ИспользоватьЛенивуюЗагрузку", ЧтениеОпций.ЗначениеОпции("lazyload"));
	ПараметрыКоманды.ИспользоватьЛенивуюЗагрузку = ЗначениеЗаполнено(ПараметрыКоманды.ИспользоватьЛенивуюЗагрузку);
	...
	ПараметрыКоманды.Вставить("МинимизироватьHTML", ЧтениеОпций.ЗначениеОпции("minifyhtml"));
	ПараметрыКоманды.МинимизироватьHTML = ЗначениеЗаполнено(ПараметрыКоманды.МинимизироватьHTML);
