...
Функция ПолучитьСписокТестов(Тестирование) Экспорт
	...
	СписокТестов.Добавить("Тест_Должен_Выполнить_Команду_checksum_СОшибкой");
	СписокТестов.Добавить("Тест_Должен_Выполнить_Команду_changelog");
	...
	СписокТестов.Добавить("Тест_Должен_Выполнить_Команду_json");
	...
	СписокТестов.Добавить("Тест_Должен_Выполнить_Команду_fs");
	...
	СписокТестов.Добавить("Тест_Должен_Выполнить_Команду_zip");
	СписокТестов.Добавить("Тест_Должен_Выполнить_Команду_zip_add_ДобавилиОдинФайлВАрхив");
	СписокТестов.Добавить("Тест_Должен_Выполнить_Команду_zip_add_ДобавилиДваФайлаВАрхив");
	СписокТестов.Добавить("Тест_Должен_Выполнить_Команду_zip_add_ДобавилиПоМаске");
	СписокТестов.Добавить("Тест_Должен_Выполнить_Команду_zip_extract");
