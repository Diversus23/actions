...
Процедура Тест_Должен_Выполнить_Команду_changelog_txt_version() Экспорт
	...
	мПараметры = СтрШаблон(Команда, ПутьФайлаТеста, ПутьФайлаТестаРезультат, "SimpleTextWithoutVersion.txt", "1.0.0.0");
	ЯВыполняюКомандуПродуктаCПередачейПараметров("changelog convert", мПараметры);
...
Функция ПолучитьСписокТестов(Тестирование) Экспорт
	...
	РегулярноеВыражениеТестовКоторыеНадоВыполнить = "Тест_Должен_Выполнить_Команду_changelog_html";
