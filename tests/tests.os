...
Процедура Тест_Должен_Выполнить_Команду_edt_versionconfig() Экспорт
	...
	Утверждения.ПроверитьИстину(Версия = "1.0.0.13", "edt_versionconfig версия не совпадает");
...
Функция ПолучитьСписокТестов(Тестирование) Экспорт
	...
	ДобавитьТест(СписокТестов, "Тест_Должен_Выполнить_Команду_edt_versionconfig");
	...
	Если ЭтоЛокальноеТестирование Тогда
		...
		// Написать тест "Тест_Должен_Выполнить_Команду_edt_versionconfig"
		//ДобавитьТест(СписокТестов, "Тест_Должен_Выполнить_Команду_infobase_create_file");
	КонецЕсли;	
