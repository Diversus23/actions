...
Процедура Тест_Должен_Выполнить_Команду_fs_deleteold() Экспорт
	...
	мПараметры = СтрШаблон("--path %1 --type min --val 1", КаталогФайлаТеста);
...
Функция ПолучитьСписокТестов(Тестирование) Экспорт
	...
	РегулярноеВыражениеТестовКоторыеНадоВыполнить = "Тест_Должен_Выполнить_Команду_fs_newtempfile";
