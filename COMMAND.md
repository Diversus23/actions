...
| [`changelog`](#changelog) | Создание из файла CHANGELOG.md текста обновления для сайта и сохраняет его в файл |
...
Создание из файла CHANGELOG.md текста обновления для сайта и сохраняет его в файл.
