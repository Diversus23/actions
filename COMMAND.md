...
- *maket*: Общий макет в конфигурации где хранится описание измененений. Необходим для создания новостей. По умолчанию "ОписаниеИзмененийСистемы" (не обязательный).
Синонимы: [--maket, -m].
